    ...
    try:
        ...
        if(editor != None):
            if(editor.currentMode == editor.MODE_MENU):
                ...
                render.showMouse(0)
                digits = 1
                cursorPos = list(logic.gameState['mapEditor'].cursor.position)
                cursorOri = list(logic.gameState['mapEditor'].cursor.orientation.to_euler())
                ...
                editing = logic.gameState['mapEditor'].editing
                if(editing):
                    mode = "edit"
                else:
                    mode = "create"
